...
public class CadastroProdutoActivity extends AppCompatActivity {
    ...
    private String usuarioAtual; // Armazenará o usuário logado
    private Produto produtoSelecionado; // Para controlar o produto selecionado no autocomplete
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Obtém o usuário atual (simplificado - você deve usar seu sistema de autenticação)
        ...
        databaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (produto != null) {
                        produto.setId(dataSnapshot.getKey()); // Armazena o ID do Firebase
    ...
    private void limparCampos() {
        ...
        produtoSelecionado = null; // Reseta o produto selecionado
    }
}